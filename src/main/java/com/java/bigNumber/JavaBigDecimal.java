...
public class JavaBigDecimal {
    public static void main(String[] args) {
        ...
        BigDecimal[] bigDecimals1 = new BigDecimal[bigDecimals.size()];
        bigDecimals.toArray(bigDecimals1);
        for(int i=0;i< bigDecimals1.length;i++) {
            s[i] = String.valueOf(bigDecimals1[bigDecimals1.length-1-i]);
        }
        !!!practice
         */
        //Output
